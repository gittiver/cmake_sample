...
// configuration step. It creates a namespace called `cmake_sample`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_sample::cmake::project_name, cmake_sample::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_sample::cmake::project_version);
      return EXIT_SUCCESS;
    }
